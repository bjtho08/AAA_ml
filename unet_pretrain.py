...
os.makedirs("logs/imagenet_pretrain/", exist_ok=True)
csv_path = "logs/imagenet_pretrain/metrics.csv"
csv_logger = CSVLogger(csv_path, append=True)

tb_path = "logs/imagenet_pretrain/tb"
...
os.makedirs("models/imagenet_pretrain/", exist_ok=True)
model_checkpoint = PatchedModelCheckpoint(
    "models/imagenet_pretrain/pretrain_epoch_{epoch}_acc_{acc:0.4f}.h5",
    verbose=0,
    monitor="acc",
    save_best_only=True,
)
